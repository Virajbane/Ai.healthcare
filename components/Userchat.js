...
const useAuth = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      setUser({
        id: "user-123", // Change to "doctor-1" to test doctor view
        firstName: "John",
        lastName: "Doe",
        publicMetadata: { role: "user" } // Change to "doctor" to test doctor view
      });
      setIsLoaded(true);
    }, 1000);
  }, []);
...
// Mock socket implementation - replace with your actual socket connection
const useSocket = () => {
