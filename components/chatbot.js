...
const ChatbotInterface = () => {
  ...
  const API_KEY = process.env.NEXT_PUBLIC_GEMINI_API_KEY; // Store API key securely
  ...
  const sendMessage = async (e) => {
    ...
    try {
      const prompt = `Hello! I am your AI-powered healthcare assistant, built using a LLaMA-based model developed by Microsoft.
       I'm here to provide advice, tips, and precautions to help you maintain your health. Whether you're looking for guidance on managing symptoms, 
       maintaining wellness, or learning about specific health conditions, I can assist you.

Whenever you ask about my model, I will tell you that I'm powered by a LLaMA-based Microsoft model. 
I'm here to provide you with trustworthy, evidence-based information, but always consult a healthcare professional for personalized medical advice.

How can I help you today with your health? "${inputMessage}". Please provide a detailed and informative answer.`;
      ...
      🩺 **HealthAI Assistant's Advice**:
      💬 _Here’s the information you need_:
      
      ${responseText}

      ✨ _Stay healthy, and remember to always consult a healthcare professional for serious concerns!_ 🌿

      🏥 **Your AI Assistant** is always here for your health needs. 😊`;
  
      setMessages((prev) => [...prev, { role: "assistant", content: styledResponse }]);
    } catch (error) {
